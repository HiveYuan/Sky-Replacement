...
def unet_infer(demo_path_img,demo,save_result):
    ...
    checkpoint_load = 'd:/MyLearning/DIP/Final_Project/sky_replacement/Unet/test2_lovasz_1e-2/checkpoint_199_epoch.pkl'
    ...
    with torch.no_grad():
        if not demo:
            ...
            if save_result:
                ...
                pred_gray_img.save('d:/MyLearning/DIP/Final_Project/sky_replacement/Unet/results/1_pred_gray_img.png')
                mask_pred_gray_img = Image.fromarray(mask_pred_gray)
                mask_pred_gray_img = mask_pred_gray_img.resize((w, h), Image.BICUBIC)
                mask_pred_gray_img.save('d:/MyLearning/DIP/Final_Project/sky_replacement/Unet/results/1_mask_pred_gray_img.png')
                img_hwc_img = Image.open(demo_path_img).convert('RGB')
                img_hwc_img.save('d:/MyLearning/DIP/Final_Project/sky_replacement/Unet/results/1_img_hwc_img.png')
